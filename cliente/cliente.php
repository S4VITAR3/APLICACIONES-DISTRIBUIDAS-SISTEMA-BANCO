...
<head>
	...
	if (isset($_SESSION['cuenta'])) {
		...
		curl_setopt_array($curl, array(
			CURLOPT_URL => "http://192.168.1.70:8080/ServidorRESTBanco/webresources/Aplicacion/consultarSaldo?numCuenta=$numero_cuenta", //url a la que se conecta
...
<body>
	<div class="card-container">
		...
		<input type="text" value="<?php echo $flag ?>" id="swal" hidden>
		<img class="round" src="img/profile.jpg" alt="user" width="250px" />
